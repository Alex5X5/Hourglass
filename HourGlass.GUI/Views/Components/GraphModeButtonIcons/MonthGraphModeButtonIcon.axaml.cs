...
public partial class MonthGraphModeButtonIcon : Avalonia.Controls.UserControl {
	...
	public override void Render(DrawingContext context) {
        ...
        DateTime firstDay = DateTimeService.GetFirstDayOfMonthAtDate(DateTime.Today);
        int weekDayCounter = DateTimeService.DayOfWorkWeek(firstDay);
        int today = weekDayCounter + DateTime.Today.Day;
