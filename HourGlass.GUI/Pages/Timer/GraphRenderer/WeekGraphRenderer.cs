...
//        float xAxisSegmentSize = (Width - 2 * PADDING_X) / 7;
...
//            if (i % 7 == 5 | i % 7 == 6)
//                g.FillRectangle(weekedDayBackground, xPos, PADDING_Y, xAxisSegmentSize-1, Height - (2 * PADDING_Y));
//            if (i+1 == (int)DateTime.Today.DayOfWeek)
//                g.FillRectangle(todayBackgroundColor, xPos, PADDING_Y, xAxisSegmentSize-1, Height - (2 * PADDING_Y));
