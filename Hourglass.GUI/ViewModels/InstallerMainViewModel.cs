...
public partial class InstallerMainViewModel : ViewModelBase {
	...
	public InstallerMainViewModel(IHourglassDbService dbService, DateTimeService dateTimeService, ViewModelFactory<PageViewModelBase> pageFactory) : base() {
